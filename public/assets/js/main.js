...
$(document).ready(function () {
  ...
  if (document.getElementById("map") && typeof google === "object") {
    var content =
      "<address>" +
      "J.F. Kennedy 705, R8340 Choele-choel,<br>" +
      "Río Negro, Argentina<br>" +
      "</address>";
    var latLong = new google.maps.LatLng(-39.2888023, -65.659328);
...
function mercadoPago() {
  ...
  if (preferencia) {
    const mp = new MercadoPago("APP_USR-d991a372-2d74-4b08-a787-e51d537d4f26", {
      locale: "es-AR",
    });
