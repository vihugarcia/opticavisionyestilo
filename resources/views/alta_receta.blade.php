...
<!-- Reenviar receta --> 
		<div class="main">
          ...
          @if(session()->has('alert_success_receta'))
            <div class="alert alert-success">La receta se <strong>cargó con éxito</strong>, puede cargar otra si desea. </div>
          @endif
		  ...
		  @if($usuario)
							...
							<form method="POST" action="/registrarreceta" enctype="multipart/form-data">          
									  ...
									  <div class="col-md-2">
										...
										<div class="col-md-2">
											<select id="ancho_cara" class="form-control" name="ancho_cara" required>
												<option selected value="">A. Cara</option>
								...
								<div class="form-group row mb-2">
									...
									<div class="col-md-2">
										...
										<option value="">Forma cara</option>
								...
								<div class="form-group row mb-2">
									...
									<div class="col-md-2">
										<select id="distancia_interpupilar" class="form-control" name="distancia_interpupilar">
											<option value="0.00" selected>D. Interpupilar</option>
									...
									<div class="col-md-2">
										<select id="distancia_nasopupilar_derecha" style="display: none;" class="form-control" name="distancia_nasopupilar_derecha">
											<option value="0.00" selected>D.N. Derecha</option>
									...
									<div class="col-md-2">
										<select id="distancia_nasopupilar_izquierda" style="display: none;" class="form-control" name="distancia_nasopupilar_izquierda">
											<option value="0.00" selected>D.N. Izquierda</option>
											<option value="54">25.00</option>
											<option value="54.50">25.50</option>
											<option value="55">26.00</option>
											<option value="55.50">26.50</option>
								  ...
								  <div class="form-group row">
									...
									<div class="col-md-6">
									  <textarea type="text" id="observaciones" class="form-control" name="observaciones"></textarea>
									</div>
								  </div>		
