		...
		<div class="main">
			...
			<main class="content">
				...
				<div class="container p-0">
					...
					<h1 class="h3 mb-3"><strong>Alta de vendedor</strong></h1>

          @if(session()->has('alert_success_medico'))
            <div class="alert alert-success">El vendedor se <strong>cargó con éxito</strong>, puede cargar otro si desea. </div>

          @endif

          <form method="POST" action="/registrarvendedor" enctype="multipart/form-data">          
