		...
		<div class="main">
			...
			<main class="content">
				<div class="container p-0">
					<h1 class="h3 mb-3"><strong>Editar cristales</strong></h1>
						@if(session()->has('alert_success_edit_cristal'))
							<div class="alert alert-success">El cristal se <strong>editó con éxito</strong> </div>		
				  		@endif
						@if(session()->has('alert_success_delete_cristal'))
							<div class="alert alert-success">El cristal se <strong>eliminó con éxito</strong></div>
						@endif
							...
							<div class="col-12 col-lg-12 col-xxl-9 d-flex">
								<div class="card flex-fill">
									<div class="card-header">
										<h5 class="card-title mb-0">Cristales registrados</h5>
									</div>
									<table class="table table-hover my-0 table-responsive">
										<thead>
											<tr>
												<th>Nombre</th>
												<th>Código</th>
												<th class="d-none d-xl-table-cell">Variante</th>
												<th class="d-none d-xl-table-cell">Descripcion</th>	
												<th class="d-none d-xl-table-cell">Tipo</th>		
												<th class="d-none d-xl-table-cell">Esfera Desde</th>	
												<th class="d-none d-xl-table-cell">Esfera Hasta</th>	
												<th class="d-none d-xl-table-cell">Cilindro Desde</th>	
												<th class="d-none d-xl-table-cell">Cilindro Hasta</th>
										...
										<tbody>
											...
											<tr>
												...
												<td class="d-none d-xl-table-cell">{{$cristal->tipo_cristal->codigo}}</td>
												<td class="d-none d-xl-table-cell">{{$cristal->tipo_cristal->variante}}</td>
												<td class="d-none d-xl-table-cell">{{$cristal->tipo_cristal->descripcion}}</td>
												<td class="d-none d-xl-table-cell">{{$cristal->tipo_cristal->tipo}}</td>
												<td class="d-none d-xl-table-cell">{{$cristal->tipo_cristal->esfera_desde}}</td>
												<td class="d-none d-xl-table-cell">{{$cristal->tipo_cristal->esfera_hasta}}</td>
												<td class="d-none d-xl-table-cell">{{$cristal->tipo_cristal->cilindro_desde}}</td>
												<td class="d-none d-xl-table-cell">{{$cristal->tipo_cristal->cilindro_hasta}}</td>
												<td class="d-none d-xl-table-cell">{{$cristal->tipo_cristal->habilitado}}</td>
												<td class="d-none d-xl-table-cell">${{$cristal->tipo_cristal->monto}}</td>												
												<td><form action="/editarcristal" method="POST">  
													@csrf
												...
												<td><form action="/eliminarcristal" method="POST">  @csrf
														<input type="hidden" value="{{$cristal->id}}" name="id">	
														<button style="border-radius: 2px;border: 1px solid gray;text-align: center;width: 50px;" type="submit">
