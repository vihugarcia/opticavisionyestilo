		...
		<div class="main">
			...
			<main class="content">
				<div class="container p-0">
					...
					@if(session()->has('alert_success_edit_usuario'))
				  	...
				  	@endif
						<div class="row">
							<div class="col-12 col-lg-12 col-xxl-9">
									...
									<form method="POST" action="/editarusuariodatos" enctype="multipart/form-data">          
										...
										<input type="hidden" value="{{$usuario->id}}" name="id">	
										  ...
										  <div class="form-group row mb-2">
											  ...
											  <div class="col-md-6">
												  <input id="name" type="text" value="{{$usuario->user->name}}" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>                
											  </div>
										  </div>
										  ...
										  <div class="form-group row mb-2">
											...
											<div class="col-md-6">
												<input id="email"  value="{{$usuario->user->email}}" type="email" class="form-control" name="email" required >
										...
										<div class="form-group row">
											<label for="cambio_id" class="col-md-4 col-form-label text-md-right">Médico</label>
											<div class="col-md-6">
											<select id="cambio_id" class="form-control" name="medico_id">		
												<option selected value="{{$usuario->medico_id}}">{{$usuario->medico->user->name}}</option>									
										  ...
										  <div class="form-group row mb-2">
											...
											<div class="col-md-6">
											  <input id="dni" type="number"  value="{{$usuario->dni}}" class="form-control" name="dni" required >
										  ...
										  <div class="form-group row mb-2">
											...
											<div class="col-md-6">
												<input id="fecha_nacimiento" type="date" value="{{$usuario->fecha_nacimiento}}" class="form-control" name="fecha_nacimiento">                
											</div>
										</div>
										...
										<div class="form-group row mb-2">
											...
											<div class="col-md-6">
												<input id="telefono" type="text" class="form-control" value="{{$usuario->user->telefono}}" name="telefono">                
											</div>
										</div>
										...
										<div class="form-group row mb-2">
											...
											<div class="col-md-6">
												<input id="celular" type="text" class="form-control" value="{{$usuario->user->celular}}" name="celular" >                
											</div>
										</div>
										...
										<div class="form-group row mb-2">
											...
											<div class="col-md-6">
												<input id="direccion" type="text" class="form-control" value="{{$usuario->user->direccion}}" name="direccion">                
											</div>
										</div>
										...
										<div class="form-group row mb-2">
											...
											<div class="col-md-6">
												<input id="obra_social" type="text" class="form-control" value="{{$usuario->obra_social}}" name="obra_social">                
											</div>
										</div>
										...
										<div class="form-group row mb-2">
											...
											<div class="col-md-6">
												<input id="afiliado" type="text" class="form-control" name="afiliado" value="{{$usuario->afiliado}}">                
											</div>
										</div>
										  ...
										  <div class="form-group row">
											...
											<img style="height: 70px" class="col-md-2" @if($usuario->img) src="img-perfil/{{$usuario->img}}" @else src="img-perfil/perfil.png" @endif>
