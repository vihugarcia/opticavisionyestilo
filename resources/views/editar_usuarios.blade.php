		...
		<div class="main">
			...
			<main class="content">
				<div class="container p-0">
					<h1 class="h3 mb-3"><strong>Editar pacientes</strong></h1>
						@if(session()->has('alert_success_edit_usuario'))
							<div class="alert alert-success">El usuario se <strong>editó con éxito</strong> </div>		
				  		@endif
						@if(session()->has('alert_success_delete_usuario'))
							<div class="alert alert-success">El usuario se <strong>eliminó con éxito</strong></div>
						@endif
									...
									<table class="table table-hover my-0 table-responsive">
										<thead>
											<tr>
												...
												<th class="d-none d-xl-table-cell">Obra social</th>	
												<th class="d-none d-xl-table-cell">Afiliado</th>	
										...
										<tbody>
											...
											<tr>
												...
												<td class="d-none d-xl-table-cell">{{$usuario->user->email}}</td>
												<td class="d-none d-xl-table-cell">{{$usuario->dni}}</td>
												<td><span class="badge bg-success">{{$usuario->user->direccion}}</span></td>
												<td class="d-none d-xl-table-cell">{{$usuario->user->telefono}}</td>
												<td class="d-none d-xl-table-cell">{{$usuario->user->celular}}</td>												
												<td class="d-none d-xl-table-cell">{{$usuario->fecha_nacimiento}}</td>
												<td class="d-none d-xl-table-cell">{{$usuario->obra_social}}</td>
												<td class="d-none d-xl-table-cell">{{$usuario->afiliado}}</td>
												<td><img style="height: 30px" @if($usuario->img) src="img-perfil/{{$usuario->img}}" @else src="img-perfil/perfil.png" @endif></td>
												<td><form action="/editarusuario" method="POST">  
													@csrf
												...
												<td><form action="/eliminarusuario" method="POST">  @csrf
														<input type="hidden" value="{{$usuario->id}}" name="id">	
														<button style="border-radius: 2px;border: 1px solid gray;text-align: center;width: 50px;" type="submit">
