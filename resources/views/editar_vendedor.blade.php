		...
		<div class="main">
			...
			<main class="content">
				<div class="container p-0">
					<h1 class="h3 mb-3"><strong>Editar vendedor</strong></h1>					
						<div class="row">
							<div class="col-12 col-lg-12">

									<form method="POST" action="/editarvendedordatos" enctype="multipart/form-data">          
										...
										<input type="hidden" value="{{$vendedor->id}}" name="id">	
										  <div class="form-group row mb-2">
											  ...
											  <div class="col-md-6">
												  <input id="name" type="text" value="{{$vendedor->user->name}}" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>                
											  </div>
										  </div>
										  ...
										  <div class="form-group row mb-2">
											...
											<div class="col-md-6">
												<input id="email"  value="{{$vendedor->user->email}}" type="email" class="form-control" name="email" required >
										...
										<div class="form-group row mb-2">
										  ...
										  <div class="col-md-6">
											  <input id="password"  value="{{$vendedor->user->password}}" type="password" class="form-control" name="password" required >                
										  </div>
										</div>
										  ...
										  <div class="form-group row mb-2">
											...
											<div class="col-md-6">
											  <input id="dni" type="number"  value="{{$vendedor->dni}}" class="form-control" name="dni" required >
										  ...
										  <div class="form-group row">
											...
											<img class="col-md-2" @if($vendedor->img) src="img-perfil/{{$vendedor->img}}" @else src="img-perfil/perfil.png" @endif>
