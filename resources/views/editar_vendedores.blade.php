		...
		<div class="main">
			...
			<main class="content">
				<div class="container p-0">
					<h1 class="h3 mb-3"><strong>Editar vendedores</strong></h1>
						@if(session()->has('alert_success_edit_vendedor'))
							<div class="alert alert-success">El vendedor se <strong>editó con éxito</strong> </div>		
				  		@endif
						@if(session()->has('alert_success_delete_vendedor'))
							<div class="alert alert-success">El vendedor se <strong>eliminó con éxito</strong></div>
						@endif
							...
							<div class="col-12 col-lg-12 col-xxl-9 d-flex">
								<div class="card flex-fill">
									<div class="card-header">
										<h5 class="card-title mb-0">Vendedores registrados</h5>
									</div>
									<table class="table table-hover my-0">
										...
										<tbody>
											...
											<tr>
												...
												<td class="d-none d-xl-table-cell">{{$vendedor->user->email}}</td>
												<td class="d-none d-xl-table-cell">{{$vendedor->dni}}</td>												
												<td><form action="/editarvendedor" method="POST">  
													@csrf
												...
												<td><form action="/eliminarvendedor" method="POST">  @csrf
														<input type="hidden" value="{{$vendedor->id}}" name="id">	
														<button style="border-radius: 2px;border: 1px solid gray;text-align: center;width: 50px;" type="submit">
