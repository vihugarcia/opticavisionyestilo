								...
								<div class="card flex-fill">								
									<table class="table">
										...
										<tbody>
											...
											<tr>
												<td class="">{{$orden->medico->user->name}}</td>																																			
												<td class="">{{$orden->direccion}}</td>	
												<td class="">{{$orden->monto}}</td>	
												<td class=""><span class="badge badge-success">{{$orden->estado}}</span></td>												
												<td class="">
													@foreach($orden->productos as $producto)
														<p>- {{$producto->nombre}}<br></p>
													@endforeach	
												</td>	
												<td class="">
													@foreach($orden->cristales as $cristal)
														<p>- {{$cristal->tipo_cristal->nombre}}<br></p>
													@endforeach	
												</td>																							
											</tr>
											@endforeach
